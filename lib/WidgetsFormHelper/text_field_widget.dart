import 'package:bankly_task/styles/colors.dart';
import 'package:bankly_task/styles/text_styles.dart';
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: TextFormField(
          ...
          validator: (value) {
            if (value.isEmpty) {
              return AppLocalizations.of(context).tr("error_mandatory_field");
            }
            return null;
          },
