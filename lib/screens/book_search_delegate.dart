...
//  }
    ...
    return FutureBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot snapshot) {
        if (!snapshot.hasData &&
          ...
          List<BookEntry> results = snapshot.data;
          if (results.isEmpty) {
            return Center(
              child: Container(
                child: Padding(
  ...
  Future<List<BookEntry>> searchBooks(String query, String searchType) async {
    LibraryService libraryService = LibraryService();
    List resultList = await libraryService.getSearchResult(
        'searchType', query, '25', '1', _sortType);
    // searchType, query, '25', '1', _sortType);
    return resultList;
  }
...
//      sortState = SortState(
//          searchType: SearchType.TITLE, sortType: SortType.YEAR_DESCENDING);
//    } finally {
...
//          _searchType = value;
//          sortBox.put(
//              0, SortState(sortType: _sortType, searchType: _searchType));
//        });
//      },
//    );
  }
